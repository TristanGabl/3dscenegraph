...
class SceneGraph3D:
    def __init__(
        ...
        OVERWRITE_1: bool = False,
        OVERWRITE_2: bool = False,
    ):
        ...
        self.OVERWRITE_1 = OVERWRITE_1
        self.logger.info("OVERWRITE_1: " + str(OVERWRITE_1))
        self.OVERWRITE_2 = OVERWRITE_2
        self.logger.info("OVERWRITE_2: " + str(OVERWRITE_2))
    ...
    def generate_3d_scene_graph(self): # main function
        ...
        # get all classes 
        self.classes = np.unique([segment_info['category_id'] for path in self.output_image_paths for segment_info in pickle.load(open(path + '.pkl', 'rb'))[1]])
        ...
        self.distribute_panoptic_segmentations() # distribute the panoptic segmentations from the images to the mesh vertices
    ...
    def run_mask2former(self):
        ...
        self.output_image_paths = [] # saved with no suffix
        for frame in self.input_image_frames:
            ...
            self.output_image_paths.append(output_image_path)
        pbar.close()
    ...
    def distribute_panoptic_segmentations(self):
        ...
        for path in self.output_image_paths:
            ...
            if self.SAVE_VISUALIZATION:
                ...
                self.logger.debug("saved projections to {}_projections.jpg".format(path))
